...
export const LayerPanel: React.FC<LayerPanelProps> = ({
  ...
  const blendModes: { value: BlendMode; label: string }[] = [
    ...
    { value: 'screen', label: 'Divisão / Screen' },
    { value: 'overlay', label: 'Sobrepor / Overlay' },
        ...
        <>
          ...
          <div className="p-2.5 border-b border-[#2d2d30] flex flex-col gap-2 bg-[#18181a]/50">
            ...
            <div className="flex items-center justify-between gap-2">
              <span className="text-[11px] font-medium text-gray-400">Modo Mesclagem:</span>
              <select
            ...
            {/* Opacity Slider */}
            <div className="flex items-center justify-between gap-2">
              <span className="text-[11px] font-medium text-gray-400">Opacidade:</span>
          ...
          <div className="flex-1 touch-scroll-y p-2 flex flex-col gap-1">
            {layers.length === 0 ? (
          ...
          {!activeLayer ? (
            ...
            <>
              <div className="text-[11px] font-semibold text-sky-400 uppercase tracking-wider">
                Ajustes da Camada: {activeLayer.name}
              </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-[11px]">
                  <span>Saturação de Cores Sublimáticas</span>
                  <span className="font-mono text-sky-400">
              ...
              <button
                ...
                className="mt-2 py-2 px-3 bg-sky-600/20 hover:bg-sky-600/30 border border-sky-500/40 rounded-lg text-sky-300 font-semibold flex items-center justify-center gap-2"
              >
                <Box className="w-4 h-4" />
                <span>
                  {activeLayer.isSmartObject
                    ? 'Rasterizar Objeto Inteligente'
